...
public class AddAllowedPlayer implements IMessage {
    private UUID uuid;

    @Deprecated
    public AddAllowedPlayer() {
    }

    public AddAllowedPlayer(UUID uuid) {
        this.uuid = uuid;
    }
    ...
    public static final IMessageHandler<AddAllowedPlayer, IMessage> HANDLER = (msg, ctx) -> {
